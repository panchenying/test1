...
p_load(dplyr, ggplot2, magrittr, psych, tidyverse, haven, broom, purrr, vcd, DHARMa, caret,
       ...
       gbm, class, e1071, stringr, knitr, kableExtra, klaR)
```
...
summary(trainmodel1) #summary of training model1
...
##Remove NA and set juvenile convictions as factor
```{r}
#Defining adult convictionsand juvenile convictions as factors in the training data
traindata %<>% 
  mutate(convicted_as_juvenile = factor(convicted_as_juvenile)) %>% 
  na.omit() #omit NAs from the data
